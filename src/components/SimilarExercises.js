...
const SimilarExercises = ({ targetMuscleExercises, equipmentExercises }) => {
  return (
    ...
    <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px' }} fontWeight={700} color="fff" mb="33px">
      Similar <span style={{ color: '#6F5EC9', textTransform: 'capitalize' }}>Target Muscle</span> exercises
    </Typography>
    ...
    <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px', mt: { lg: '100px', xs: '60px' } }} fontWeight={700} color="#fff" mb="33px">
      Similar <span style={{ color: '#6F5EC9', textTransform: 'capitalize' }}>Equipment</span> exercises
    </Typography>
    <Stack direction="row" sx={{ p: 2, position: 'relative' }}>
